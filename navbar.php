...
<nav class="navbar navbar-default ">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">ControlAPP</a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="<?php if (isset($active_empleados)){echo $active_empleados;}?>"><a href="empleados.php"><i  class='glyphicon glyphicon-user'></i> Empleados</a></li>
       </ul>
      <ul class="nav navbar-nav navbar-right">
        <!-- original -->
		<!-- <li><a href="#" target='_blank'><i class='glyphicon glyphicon-envelope'></i> Soporte</a></li> -->
		<li><a href="#" target='_blank'><i class='glyphicon glyphicon-book'></i> Manual</a></li>
